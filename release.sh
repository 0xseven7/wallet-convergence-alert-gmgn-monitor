...
ITEMS=(manifest.json background.js popup.html settings.html popup.css popup.js icons sounds lib xxyy gmgn)
...
if command -v 7z >/dev/null 2>&1; then
  ...
  powershell.exe -NoProfile -Command "Compress-Archive -Path 'manifest.json','background.js','popup.html','settings.html','popup.css','popup.js','icons','sounds','lib','xxyy','gmgn' -DestinationPath '$OUT' -Force"
fi
